  ...
  const getCardPool = () => {
    const cardPool: LayoutCard[] = [
      ...
      },
      {
        ...
        title: '我的卡片3',
        width: 12,
        description: '除了主色外的场景色，需要在不同的场景中使用（例如危险色表示危险的操作）。',
        height: LayoutCardHeight.SMALL
      },
      {
        id: getRandomId(),
        ...
        title: '我的卡片4',
        width: 6,
        description: '中性色用于文本、背景和边框颜色。通过运用不同的中性色，来表现层次结构。',
        height: LayoutCardHeight.SMALL
      },
      {
        id: getRandomId(),
        ...
        title: '我的卡片5',
        width: 8,
        description: '我们对字体进行统一规范，力求在各个操作系统下都有最佳展示效果。',
        height: LayoutCardHeight.SMALL
      }
    ]
    return cardPool
